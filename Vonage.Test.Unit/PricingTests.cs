        ...
        public void GetPricingForCountry(bool passCreds)
        {
            ...
            if (passCreds)
            {
                country = client.PricingClient.RetrievePricingCountry("sms",
                    new Pricing.PricingCountryRequest {Country = "CA"}, creds);
            }
            else
            {
                country = client.PricingClient.RetrievePricingCountry("sms",
                    new Pricing.PricingCountryRequest {Country = "CA"});
            }
        ...
        public void GetPricingForPrefix(bool passCreds)
        {
            ...
            if (passCreds)
            {
                pricing = client.PricingClient.RetrievePrefixPricing("sms",
                    new Pricing.PricingPrefixRequest {Prefix = "1"}, creds);
            }
            else
            {
                pricing = client.PricingClient.RetrievePrefixPricing("sms",
                    new Pricing.PricingPrefixRequest {Prefix = "1"});
            }
