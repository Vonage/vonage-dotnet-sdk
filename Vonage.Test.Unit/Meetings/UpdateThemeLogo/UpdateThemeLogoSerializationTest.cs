...
{
    public class UpdateThemeLogoSerializationTest
    {
        private readonly SerializationTestHelper helper;

        public UpdateThemeLogoSerializationTest() =>
            this.helper = new SerializationTestHelper(typeof(UpdateThemeLogoSerializationTest).Namespace,
