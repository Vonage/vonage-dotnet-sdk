...
namespace Vonage.Test.Unit.Meetings.GetRoom
{
    public class GetRoomTest : BaseUseCase
    {
        ...
        public GetRoomTest() => this.request = BuildRequest(this.helper.Fixture);
        ...
        public async Task ShouldReturnFailure_GivenRequestIsFailure() =>
            await this.helper.VerifyReturnsFailureGivenRequestIsFailure<GetRoomRequest, Room>(
                (configuration, failureRequest) =>
                    new MeetingsClient(configuration, new MockFileSystem()).GetRoomAsync(failureRequest));
