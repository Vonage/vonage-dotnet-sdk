...
{
    public class GetRoomsByThemeDeserializationTest
    {
        private readonly SerializationTestHelper helper;

        public GetRoomsByThemeDeserializationTest() =>
            this.helper = new SerializationTestHelper(typeof(GetRoomsByThemeDeserializationTest).Namespace,
