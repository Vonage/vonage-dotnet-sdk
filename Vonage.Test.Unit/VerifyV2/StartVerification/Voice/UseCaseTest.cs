...
namespace Vonage.Test.Unit.VerifyV2.StartVerification.Voice
{
    public class UseCaseTest : BaseUseCase
    {
        ...
        private readonly Result<StartVerificationRequest<VoiceWorkflow>> request;
        ...
        public async Task ShouldReturnFailure_GivenRequestIsFailure() =>
            await this.helper
                .VerifyReturnsFailureGivenRequestIsFailure<StartVerificationRequest<VoiceWorkflow>,
        ...
        private static Result<StartVerificationRequest<VoiceWorkflow>> BuildRequest(
