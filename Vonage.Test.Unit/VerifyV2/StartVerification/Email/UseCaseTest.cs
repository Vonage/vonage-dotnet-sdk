...
namespace Vonage.Test.Unit.VerifyV2.StartVerification.Email
{
    public class UseCaseTest : BaseUseCase
    {
        ...
        private readonly Result<StartVerificationRequest<EmailWorkflow>> request;
        ...
        public async Task ShouldReturnFailure_GivenRequestIsFailure() =>
            await this.helper
                .VerifyReturnsFailureGivenRequestIsFailure<StartVerificationRequest<EmailWorkflow>,
        ...
        private static Result<StartVerificationRequest<EmailWorkflow>> BuildRequest(ISpecimenBuilder fixture) =>
