...
public class SerializationTest
{
    ...
    public void ShouldDeserialize200() =>
        this.helper.Serializer
            ...
            .BeSuccess(success =>
            {
                success.Events.ToArray()[0].OccurredAt.Should().Be(DateTimeOffset.Parse("2022-08-07T13:18:21.970Z"));
                ...
                success.Events.ToArray()[1].OccurredAt.Should().Be(DateTimeOffset.Parse("2022-08-07T13:18:20.289Z"));
