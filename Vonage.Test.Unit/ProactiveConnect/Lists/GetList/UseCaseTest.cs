...
namespace Vonage.Test.Unit.ProactiveConnect.Lists.GetList
{
    public class UseCaseTest : BaseUseCase, IUseCaseWithResponse
    {
        private Func<VonageHttpClientConfiguration, Task<Result<List>>> Operation =>
            configuration => new ProactiveConnectClient(configuration).GetListAsync(this.request);

        private readonly Result<GetListRequest> request;
        ...
        public async Task ShouldReturnFailure_GivenRequestIsFailure() =>
            await this.helper
                .VerifyReturnsFailureGivenRequestIsFailure<GetListRequest, List>(
                    (configuration, failureRequest) =>
                        new ProactiveConnectClient(configuration).GetListAsync(failureRequest));
        ...
        private static Result<GetListRequest> BuildRequest(ISpecimenBuilder fixture) =>
            GetListRequest.Parse(fixture.Create<Guid>());
    }
}