...
{
    public class MuteStreamTest : BaseUseCase
    {
        ...
        public MuteStreamTest() => this.request = BuildRequest(this.Helper.Fixture);
        ...
        public async Task ShouldReturnFailure_GivenRequestIsFailure() =>
            await this.Helper.VerifyReturnsFailureGivenRequestIsFailure<MuteStreamRequest, MuteStreamResponse>(
                (configuration, failureRequest) =>
                    new ModerationClient(configuration).MuteStreamAsync(failureRequest));
