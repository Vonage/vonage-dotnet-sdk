...
{
    public class StopBroadcastSerializationTest
    {
        private readonly SerializationTestHelper helper;

        public StopBroadcastSerializationTest() =>
            this.helper = new SerializationTestHelper(typeof(StopBroadcastSerializationTest).Namespace,
