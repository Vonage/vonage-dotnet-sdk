...
namespace Nexmo.Api
{
    public static class Account
    {
        ...
        {
            var response = ApiRequest.DoRequest(ApiRequest.GetBaseUriFor(typeof(Account),
                "/account/get-balance"),
                // TODO: using this method sig allows us to have the api auth injected at the expense of opaque code here
                new Dictionary<string, string>(),
                credentials);

            var obj = JsonConvert.DeserializeObject<Balance>(response);
            return obj;
        }
        ...
        public static Pricing GetPricing(string country, string type = null, Credentials credentials = null)
        {
            ...
            var obj = JsonConvert.DeserializeObject<Pricing>(response);
            return obj;
        }
       
        /// <summary>
        /// Retrieve our outbound pricing for a given prefix
        /// </summary>
        ...
        {
            var response = ApiRequest.DoRequest(ApiRequest.GetBaseUriFor(typeof(Account), "/account/numbers"), request, credentials);
            return JsonConvert.DeserializeObject<NumbersResponse>(response);
        }
    }
}