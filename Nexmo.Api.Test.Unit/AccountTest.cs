...
@"{""value"": 3.14159, ""autoReload"": false }");
            ...
            Assert.AreEqual(3.14159d, balance.value);
...
$"newSecret=newSecret1&moCallBackUrl=http%3a%2f%2fmo.callbackurl.com&drCallBackUrl=http%3a%2f%2fdr.callbackurl.com&api_key={ApiKey}&api_secret={ApiSecret}&");
