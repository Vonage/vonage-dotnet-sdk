...
namespace Vonage.Video.Beta.Test.Video.Archives.GetArchives
{
    public class GetArchivesRequestTest
    {
        ...
        public void Parse_ShouldReturnFailure_GivenOffsetIsNegative() =>
            GetArchivesRequest.Parse(fixture.Create<string>(), -1)
                .Should()
        ...
        public void Parse_ShouldReturnFailure_GivenCountIsNegative() =>
            GetArchivesRequest.Parse(fixture.Create<string>(), count: -1)
                .Should()
        ...
        public void Parse_ShouldReturnFailure_GivenCountIsHigherThanThreshold() =>
            GetArchivesRequest.Parse(fixture.Create<string>(), count: 1001)
                .Should()
