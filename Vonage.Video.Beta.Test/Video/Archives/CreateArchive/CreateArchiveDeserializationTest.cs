...
{
    public class CreateArchiveDeserializationTest
    {
        private readonly SerializationTestHelper helper;

        public CreateArchiveDeserializationTest() =>
            this.helper = new SerializationTestHelper(typeof(CreateArchiveDeserializationTest).Namespace);
        ...
        public void ShouldDeserialize200() =>
            this.helper.Serializer
                ...
                .BeSuccess(success =>
                {
                    ...
                    success.Resolution.Should().Be("abc123");
