...
{
    [System.Obsolete("The Nexmo.Api.Cryptography.SmsSignatureGenerator class is obsolete. " +
        "References to it should be switched to the new Vonage.Cryptography.SmsSignatureGenerator class.")]
