...
{
    [System.Obsolete("The Nexmo.Api.Voice.Nccos.Endpoints.PhoneEndpoint class is obsolete. " +
           "References to it should be switched to the new Nexmo.Api.Voice.Nccos.Endpoints.PhoneEndpoint class.")]
