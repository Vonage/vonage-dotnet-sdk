...
{
    [System.Obsolete("The Nexmo.Api.Voice.EventWebhooks.EventBase class is obsolete. " +
        "References to it should be switched to the new Vonage.Voice.EventWebhooks.EventBase class.")]
