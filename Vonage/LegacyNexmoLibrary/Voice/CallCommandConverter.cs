...
{
    [System.Obsolete("The Nexmo.Api.Voice.CallCommandConverter class is obsolete. " +
           "References to it should be switched to the new Nexmo.Api.Voice.CallCommandConverter class.")]
