...
{
    [System.Obsolete("The Nexmo.Api.Voice.CallEditCommand class is obsolete. " +
           "References to it should be switched to the new Nexmo.Api.Voice.CallEditCommand class.")]
