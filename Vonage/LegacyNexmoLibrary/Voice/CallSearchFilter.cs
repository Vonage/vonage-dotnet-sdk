...
{
    [System.Obsolete("The Nexmo.Api.Voice.CallSearchFilter class is obsolete. " +
           "References to it should be switched to the new Nexmo.Api.Voice.CallSearchFilter class.")]
