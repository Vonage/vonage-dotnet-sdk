...
{
    [System.Obsolete("The Nexmo.Api.NumberInsights.BasicNumberInsightRequest class is obsolete. " +
        "References to it should be switched to the new Vonage.NumberInsights.BasicNumberInsightRequest class.")]
