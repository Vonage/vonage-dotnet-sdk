...
{
    [System.Obsolete("The Nexmo.Api.NumberInsights.StandardInsightResponse class is obsolete. " +
        "References to it should be switched to the new Vonage.NumberInsights.StandardInsightResponse class.")]
