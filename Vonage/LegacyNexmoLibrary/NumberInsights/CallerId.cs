...
{
    [System.Obsolete("The Nexmo.Api.NumberInsights.CallerId class is obsolete. " +
        "References to it should be switched to the new Vonage.NumberInsights.CallerId class.")]
