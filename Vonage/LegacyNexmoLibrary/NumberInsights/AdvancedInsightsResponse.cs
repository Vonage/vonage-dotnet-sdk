...
{
    [System.Obsolete("The Nexmo.Api.NumberInsights.AdvancedInsightsResponse class is obsolete. " +
        "References to it should be switched to the new Vonage.NumberInsights.AdvancedInsightsResponse class.")]
