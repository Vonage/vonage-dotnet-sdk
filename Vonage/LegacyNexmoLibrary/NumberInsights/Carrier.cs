...
{
    [System.Obsolete("The Nexmo.Api.NumberInsights.Carrier class is obsolete. " +
        "References to it should be switched to the new Vonage.NumberInsights.Carrier class.")]
