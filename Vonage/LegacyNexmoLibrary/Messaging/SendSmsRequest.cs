...
{
    [System.Obsolete("The Nexmo.Api.Messaging.SendSmsRequest class is obsolete. " +
        "References to it should be switched to the new Vonage.Messaging.SendSmsRequest class.")]
