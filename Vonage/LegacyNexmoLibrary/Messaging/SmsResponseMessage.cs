...
{
    [System.Obsolete("The Nexmo.Api.Messaging.SmsResponseMessage class is obsolete. " +
        "References to it should be switched to the new Vonage.Messaging.SmsResponseMessage class.")]
