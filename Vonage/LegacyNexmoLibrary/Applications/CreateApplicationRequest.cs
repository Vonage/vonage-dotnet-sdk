...
{
    [System.Obsolete("The Nexmo.Api.Applications.CreateApplicationRequest class is obsolete. " +
        "References to it should be switched to the new Vonage.Applications.CreateApplicationRequest class.")]
