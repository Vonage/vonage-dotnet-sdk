...
{
    [System.Obsolete("The Nexmo.Api.Applications.IApplicationClient interface is obsolete. " +
        "References to it should be switched to the new Vonage.Applications.IApplicationClient interface.")]
