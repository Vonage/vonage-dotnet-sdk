...
{
    [System.Obsolete("The Nexmo.Api.Accounts.AccountSettingsResult class is obsolete. " +
        "References to it should be switched to the new Vonage.Accounts.AccountSettingsResult class.")]
