...
{
    [System.Obsolete("The Nexmo.Api.Verify.VerifyCheckResponse class is obsolete. " +
        "References to it should be switched to the new Vonage.Verify.VerifyCheckResponse class.")]
