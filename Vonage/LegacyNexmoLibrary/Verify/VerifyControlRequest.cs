...
{
    [System.Obsolete("The Nexmo.Api.Verify.VerifyControlRequest class is obsolete. " +
        "References to it should be switched to the new Vonage.Verify.VerifyControlRequest class.")]
