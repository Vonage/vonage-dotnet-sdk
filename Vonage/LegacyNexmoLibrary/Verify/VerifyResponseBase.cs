...
{
    [System.Obsolete("The Nexmo.Api.Verify.VerifyResponseBase class is obsolete. " +
        "References to it should be switched to the new Vonage.Verify.VerifyResponseBase class.")]
