...
{
    [System.Obsolete("The Nexmo.Api.Verify.VerifySearchResponse class is obsolete. " +
        "References to it should be switched to the new Vonage.Verify.VerifySearchResponse class.")]
