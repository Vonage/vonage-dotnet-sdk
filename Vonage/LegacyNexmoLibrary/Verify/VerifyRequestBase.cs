...
{
    [System.Obsolete("The Nexmo.Api.Verify.VerifyRequestBase class is obsolete. " +
        "References to it should be switched to the new Vonage.Verify.VerifyRequestBase class.")]
