...
{
    [System.Obsolete("The Nexmo.Api.Numbers.NumbersClient class is obsolete. " +
        "References to it should be switched to the new Vonage.Numbers.NumbersClient class.")]
