...
{
    [System.Obsolete("The Nexmo.Api.Numbers.NumberSearchRequest class is obsolete. " +
        "References to it should be switched to the new Vonage.Numbers.NumberSearchRequest class.")]
