...
{
    [System.Obsolete("The Nexmo.Api.Numbers.UpdateNumberRequest class is obsolete. " +
        "References to it should be switched to the new Vonage.Numbers.UpdateNumberRequest class.")]
