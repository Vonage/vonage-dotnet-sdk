...
namespace Vonage.Reports.CreateReport;

/// <summary>
///     Represents a request to create an asynchronous report. The report is generated in the background;
///     use the returned request ID with <see cref="GetReport.GetReportRequest"/> to poll for completion.
/// </summary>
[Builder]
public readonly partial struct CreateReportRequest : IVonageRequest
{
    ...
    /// </example>
    [Optional]
    public Maybe<bool> IncludeSubaccounts { get; internal init; }
    ...
    /// </example>
    [Optional]
    public Maybe<Uri> CallbackUrl { get; internal init; }
    ...
    /// </example>
    [Optional]
    public Maybe<string> ClientRef { get; internal init; }
    ...
    public HttpRequestMessage BuildRequestMessage() => VonageRequestBuilder
        .Initialize(HttpMethod.Post, "/v2/reports")
        .WithContent(this.GetRequestContent())
        .Build();

    [ValidationRule]
    internal static Result<CreateReportRequest> VerifyAccountId(CreateReportRequest request) =>
        InputValidation.VerifyNotEmpty(request, request.AccountId, nameof(request.AccountId));

    private StringContent GetRequestContent() =>
        new(JsonSerializerBuilder.BuildWithSnakeCase().SerializeObject(this.GetBodyParameters()),
            Encoding.UTF8, "application/json");

    private Dictionary<string, object> GetBodyParameters()
    {
        ...
        this.IncludeSubaccounts.IfSome(v => parameters.Add("include_subaccounts", v));
        this.CallbackUrl.IfSome(v => parameters.Add("callback_url", v.ToString()));
        ...
        this.ClientRef.IfSome(v => parameters.Add("client_ref", v));
        this.AccountRef.IfSome(v => parameters.Add("account_ref", v));
        this.IncludeMessage.IfSome(v => parameters.Add("include_message", v));
        this.ShowConcatenated.IfSome(v => parameters.Add("show_concatenated", v));
        ...
        this.Swapped.IfSome(v => parameters.Add("swapped", v));
