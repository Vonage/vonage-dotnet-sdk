...
namespace Vonage.ApplicationsNew.UpdateApplication;

/// <summary>
///     Represents a request to update an existing Vonage application.
/// </summary>
[Builder]
public readonly partial struct UpdateApplicationRequest : IVonageRequest
{
    /// <summary>
    ///     Sets the unique identifier of the application to update.
    /// </summary>
    [JsonIgnore]
    [Mandatory(0)]
    ...
    /// <summary>
    ///     Sets the new application name. This does not need to be unique.
    /// </summary>
    [Mandatory(1)]
    ...
    public HttpRequestMessage BuildRequestMessage() => VonageRequestBuilder
        .Initialize(HttpMethod.Put, $"/v2/applications/{this.ApplicationId}")
    ...
    [ValidationRule]
    internal static Result<UpdateApplicationRequest> VerifyApplicationId(UpdateApplicationRequest request) =>
        InputValidation.VerifyNotEmpty(request, request.ApplicationId, nameof(request.ApplicationId));

    [ValidationRule]
    internal static Result<UpdateApplicationRequest> VerifyName(UpdateApplicationRequest request) =>
