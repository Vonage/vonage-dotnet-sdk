...
public class CallCommand
{
    ...
    public record AdvancedMachineDetectionProperties(
        [property: JsonProperty("behavior", Order = 0, DefaultValueHandling = DefaultValueHandling.Include)]
        [property: JsonConverter(typeof(StringEnumConverter))]
        AdvancedMachineDetectionProperties.MachineDetectionBehavior Behavior,
        [property: JsonProperty("mode", Order = 1, DefaultValueHandling = DefaultValueHandling.Include)]
        [property: JsonConverter(typeof(StringEnumConverter))]
        AdvancedMachineDetectionProperties.MachineDetectionMode Mode,
        [property: JsonProperty("beep_timeout", Order = 2)]
        int BeepTimeout)
    {
        /// <summary>
