...
public sealed class Configuration
{
    ...
    private Uri FetchApiUrlEurope() =>
        this.Settings["vonage:Vonage.Url.Api.Europe"] is null
...
public readonly struct VonageUrls
{
    ...
    private const string NexmoApiKey = "vonage:Vonage.Url.Api";
    private const string NexmoRestKey = "vonage:Vonage.Url.Rest";
    private const string VideoApiKey = "vonage:Vonage.Url.Api.Video";
