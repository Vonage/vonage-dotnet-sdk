...
public class StartVerificationRequestBuilderV2<T> :
    ...
    where T : IVerificationWorkflow
{
    ...
    // private static Result<StartVerificationRequest<T>> VerifyWorkflowHashLength(
    ...
    // }
    //
    // private static Result<StartVerificationRequest<T>> VerifyWorkflowHashNotEmpty(
    //     StartVerificationRequest<T> request)
    // {
    //     var workflow = request.Workflows.First();
    ...
    // }
    //
    // private static Result<StartVerificationRequest<T>> VerifyWorkflowToNotEmpty(
    //     StartVerificationRequest<T> request)
    // {
    //     var workflow = request.Workflows.First();
